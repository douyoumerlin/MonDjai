...
import { Plus, Trash2, Edit3, Save, X, Receipt, Palette } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="bg-purple-500 hover:bg-purple-600 text-white px-3 py-2 rounded-xl transition-colors duration-200 flex items-center gap-2 text-sm"
          >
            <Palette size={16} />
